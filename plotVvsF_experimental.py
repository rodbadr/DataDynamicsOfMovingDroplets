...
i=0
ax.errorbar(v1,F1, yerr=sigF1, linestyle= 'none', marker=mar[i], color=col[i], label='grafted from' )
i=1
ax.errorbar(v2,F2, yerr=sigF2, linestyle= 'none', marker=mar[i], color=col[i], label='grafted to' )

ax.text(8, 1.2e-5, '(a)', fontsize=12)

ax.set_ylim([0.9e-5, 1.1e-4])
...
plt.savefig("figures/VvsF_exp_loglog.pdf")
